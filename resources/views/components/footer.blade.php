        ...
        <div class="keep-in-touch">
            ...
            <ul class="contact-links">
                <li>
                    ...
                    <a href="mailto:valcarbid@gmail.com">valcarbid@gmail.com</a>
                </li>
                <li>
                    <i class="fa fa-phone" aria-hidden="true"></i>
                    <a href="tel:+37300800000">+373 (00) 80 00 00 </a>
                </li>
                <li>
                    <i class="fa fa-fax" aria-hidden="true"></i>
                    <a href="tel:+37300900000">+373 (00) 90 00 00</a>
                </li>
                <li>
                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                    <a href="https://www.google.com/maps/search/?q=139+Decebal+Blvd,+MD" class="address">139 Decebal Blvd, MD</a>
                </li>
            </ul>
        </div>
