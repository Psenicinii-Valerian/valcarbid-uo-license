...
class CreateExpiredCarsTable extends Migration
{
    public function up()
    {
        Schema::create('expired_cars', function (Blueprint $table) {
            $table->id(); 
            $table->unsignedBigInteger('expired_car_id')->unique(); 
    ...
    {
        Schema::dropIfExists('expired_cars');
    }
}
